...
var allStimuli = [
	...
	{"Story":["polar;When NAME and PRONOUN friend had lunch last week, they resolved to reach out to their signWhether or noticant others more often. They are going to have lunch together again today. When they arrive at the restaurant, PRONOUN friend asks who SUBJPRONOUN's been in touch with today.","exhaustive;NAME and PRONOUN friend both enjoy talking on the phone to their friends and loved ones, and are going to have lunch together. When they arrive at the restaurant, PRONOUN friend asks who SUBJPRONOUN's been in touch with today."],"Polar":"Whether or not NAME spoke to PRONOUN partner on the phone","Exhaustive":"All of the people that NAME spoke to on the phone","Scenario":"I spoke to my partner on the phone."},
	{"Story":["polar;The last time NAME and PRONOUN friend got together, they made a pact that they would visit San Francisco before they saw each other again. They are having a drink together again today. When they reach the bar, PRONOUN friend asks where SUBJPRONOUN's traveled to lately.","exhaustive;NAME and PRONOUN friend absolutely love to travel, and they are having a drink together today. When they reach the bar, PRONOUN friend asks where SUBJPRONOUN's traveled to lately."],"Polar":"Whether or not NAME traveled to San Francisco","Exhaustive":"All of the places that NAME traveled to","Scenario":"I traveled to San Francisco."},
	{"Story":["polar;The last time NAME and PRONOUN friend hung out, they decided they would sign up for a pottery class by time time they met up next. They are eating dinner together today. Once they turn up at the restaurant, PRONOUN friend asks what classes SUBJPRONOUN's signed up for recently.","exhaustive;NAME and PRONOUN friend are both fond of taking classes outside of work, and they are eating dinner together today. Once they turn up at the restaurant, PRONOUN friend asks what classes SUBJPRONOUN's signed up for recently."],"Polar":"Whether or not NAME signed up for a pottery class","Exhaustive":"All of the classes that NAME signed up for","Scenario":"I signed up for a pottery class."},
...
function makeStims() {
	...
	//need to draw a name and replace NAME, PRONOUN, SUBJPRONOUN for story, polar, and exhaustive answer choices 
		...
		//pushing stim 
		stims.push({"Name":name.NAME,"Story":story,"QUD":qud,"Polar":polarChoice,"Exhaustive":exhaustiveChoice});
	}
