...
var allStimuli = [
	...
	{"Story":["polar;When NAME and PRONOUN friend had lunch last week, they resolved to reach out to their signWhether or noticant others more often. They are going to have lunch together again today. When they arrive at the restaurant, PRONOUN friend asks who SUBJPRONOUN's been in touch with today.","exhaustive;NAME and PRONOUN friend both enjoy talking on the phone to their friends and loved ones, and are going to have lunch together. When they arrive at the restaurant, PRONOUN friend asks who SUBJPRONOUN's been in touch with today."],"Polar":"Whether or not NAME spoke to PRONOUN partner on the phone","Exhaustive":"All of the people that NAME spoke to on the phone","Scenario":"I spoke to my partner on the phone.","TrialType":"critical"},
...
var fillers = [
	...
	{"Story": "When NAME and PRONOUN friend caught up at a mutual friend’s place the other night, they agreed to try to get to know each other better. They are having coffee together this morning. At the entrance to the coffee shop, PRONOUN friend asks what city SUBJPRONOUN was born in.","Polar":"The city where NAME was born","Exhaustive":"NAME's mother's maiden name", "Scenario":"I was born in New York","TrialType":"filler","QUD":"polar"},
