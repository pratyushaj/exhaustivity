...
modelPrior = set_prior("uniform(-1,1)", class = "b",lb="-1",ub="1")

m = brm(response ~ cqud * cPrior * cSensitivity * cBlock + (1 |Topic) + (1|workerid), save_all_pars=TRUE,data=ad,control = list(adapt_delta = 0.9999),iter = 1000,prior=modelPrior)
